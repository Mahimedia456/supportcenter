...
Write-Host "Support Command Center - Phase 10 Device Health" -ForegroundColor Cyan
Write-Host "Device volume, Faulty/RMA signals, issues, regions, trends and ticket drill-down"
...
Write-Host ""
Write-Host "PASS: Phase 10 installed and verified." -ForegroundColor Green
Write-Host ""
Write-Host "Run:"
