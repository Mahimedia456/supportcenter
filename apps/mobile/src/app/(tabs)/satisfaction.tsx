  ...
  return (
    ...
    >
      ...
      <Text style={s.caption}>
        Ratings and comments from the shared support snapshot
      </Text>
      ...
      >
        ...
        >
          ...
          >
            {comments.length} of {ratings.length} ratings include a written comment.
          </Text>
        </View>
      ...
      !snapshot ? (
        ...
        >
          ...
          >
            Loading saved satisfaction snapshot…
          </Text>
        </View>
      ) : null}
