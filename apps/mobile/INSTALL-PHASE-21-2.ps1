...
Write-Host "Support Command Center - Phase 21.2 Home Date Filter Compatibility Fix" -ForegroundColor Cyan
...
$HomeText = Read-AllText $Home

if ($HomeText -notmatch "period=\{period\}") {
    throw "Current Home period prop not found."
}

if ($HomeText -notmatch "onCustom=") {
...
Write-Host ""
Write-Host "PASS: Phase 21.2 TypeScript clean." -ForegroundColor Green
